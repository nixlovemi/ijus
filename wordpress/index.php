                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="col-lg-7 col-lg-offset-4 text-center">
                            <a href="sobre-nos.php" class="link-home"><h2 class="section-heading primary" style="display:inline">QUEM SOMOS?</h2></a>
                            <hr class="primary">
                            <p class="text-muted text-justify">
                                O <strong class="primary">IJUS</strong> é um espaço público permanente de diálogo, debate e ação
                                coletiva entre seus associados e a sociedade em geral, que visa
                                contribuir para o desenvolvimento sustentável de Juruti e entorno.
                                O instituto tem por escopo também apoiar financeiramente ações,
                                projetos e programas, reembolsáveis ou não reembolsáveis que
                                integrem aspectos sociais, humanos econômicos e ambientais
                                através do Fundo <strong class="primary">JURUTI Sustentável - FUNJUS</strong>
                            </p>
